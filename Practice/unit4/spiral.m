...
function runTest
    ...
    % Run reference solution for comparison (replace reference.readMatrixCCW with the correct call for your reference)
    bRef = reference.readMatrixCCW(a); 
    
    % Compare the result with the reference solution
    assessVariableEqual('b', bRef);  % Use your assessment function if different
end
